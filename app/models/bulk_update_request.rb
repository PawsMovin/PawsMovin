  ...
  module ApprovalMethods
    ...
    def create_forum_topic
      ...
      if forum_topic_id
        ...
        forum_topic = ForumTopic.create(title: title, category_id: PawsMovin.config.alias_implication_forum_category, original_post_attributes: {body: reason_with_link})
